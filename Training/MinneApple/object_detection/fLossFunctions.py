...
class TaskAlignedAssigner(nn.Module):
    ...
    def forward(self, pd_scores, pd_bboxes, anc_points, gt_labels, gt_bboxes, mask_gt):
        ...
        return target_labels, target_bboxes, target_scores, fg_mask.bool(), target_gt_idx # (b, h*w), (b, h*w, 4), (b, h*w, nc), (b, h*w), (b, h*w)
    ...
    def get_targets(self, gt_labels, gt_bboxes, target_gt_idx, fg_mask):
        ...
        return target_labels, target_bboxes, target_scores # (b, h*w), (b, h*w, 4), (b, h*w, nc)
...
class v8DetectionLoss:
    ...
    def __call__(self, feats, batch, depth=True):
        ...
        _, target_bboxes, target_scores, fg_mask, _ = self.assigner(
            ...
            anchor_points * stride_tensor, gt_labels, gt_bboxes, mask_gt)  # _, (b, h*w, 4), (b, h*w, nc), (b, h*w), _
